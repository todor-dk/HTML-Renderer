    ...
    public class DemoUtils
    {
        ...
        public static string RunSamplesPerformanceTest(Action<String> setHtmlDelegate)
        {
            ...
            msg += string.Format(
                ...
                elapsedMilliseconds,
                elapsedMilliseconds / (double)Iterations,
                elapsedMilliseconds / (double)Iterations / sampleCount);
            ...
            if (Environment.Version.Major >= 4)
            {
                ...
                msg += string.Format(
                    ...
                    memory,
                    memory / Iterations,
                    memory / Iterations / sampleCount,
                    100 * (memory / Iterations) / htmlSize);
            }
            ...
            msg += string.Format(
                ...
                runStopwatch.ElapsedMilliseconds / (double)Iterations,
                runStopwatch.ElapsedMilliseconds / (double)Iterations / sampleCount);
            ...
            if (Environment.Version.Major >= 4)
            {
                ...
                msg += string.Format(
                    "Full Memory:\r\nTotal: {0:N0} KB\r\nIterationAvg: {1:N0} KB\r\nSingleAvg: {2:N0} KB\r\nOverhead: {3:N0}%",
                    runMemory,
                    runMemory / Iterations,
                    runMemory / Iterations / sampleCount,
                    100 * (runMemory / Iterations) / htmlSize);
            }
