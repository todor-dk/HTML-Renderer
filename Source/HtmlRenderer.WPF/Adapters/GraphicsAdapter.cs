...
namespace TheArtOfDev.HtmlRenderer.WPF.Adapters
{
    ...
    internal sealed class GraphicsAdapter : RGraphics
    {
        ...
        public override void PushClip(RRect rect)
        {
            ...
            this.Graphics.PushClip(new RectangleGeometry(Utils.Convert(rect)));
        }

        public override void PushClipExclude(RRect rect)
        {
            var geometry = new CombinedGeometry();
            geometry.Geometry1 = new RectangleGeometry(Utils.Convert(this.ClipStack.Peek()));
            ...
            this.Graphics.PushClip(geometry);
        }
        ...
        {
            var colorConv = ((BrushAdapter)this.Adapter.GetSolidBrush(color)).Brush;
            ...
            if (glyphTypeface != null)
            {
                ...
                if (i >= str.Length)
                {
                    ...
                    this.Graphics.DrawGlyphRun(colorConv, glyphRun);
                }
            }
            ...
            if (!glyphRendered)
            {
                ...
                this.Graphics.DrawText(formattedText, Utils.ConvertRound(point));
            }
        }
        ...
        public override void DrawLine(RPen pen, double x1, double y1, double x2, double y2)
        {
            ...
            this.Graphics.DrawLine(((PenAdapter)pen).CreatePen(), new Point(x1, y1), new Point(x2, y2));
        }
        ...
        public override void DrawRectangle(RPen pen, double x, double y, double width, double height)
        {
            ...
            this.Graphics.DrawRectangle(null, ((PenAdapter)pen).CreatePen(), new Rect(x, y, width, height));
        }

        public override void DrawRectangle(RBrush brush, double x, double y, double width, double height)
        {
            this.Graphics.DrawRectangle(((BrushAdapter)brush).Brush, null, new Rect(x, y, width, height));
        }
        ...
        public override void DrawImage(RImage image, RRect destRect, RRect srcRect)
        {
            ...
            this.Graphics.DrawImage(croppedImage, Utils.ConvertRound(destRect));
        }

        public override void DrawImage(RImage image, RRect destRect)
        {
            this.Graphics.DrawImage(((ImageAdapter)image).Image, Utils.ConvertRound(destRect));
        }

        public override void DrawPath(RPen pen, RGraphicsPath path)
        {
            this.Graphics.DrawGeometry(null, ((PenAdapter)pen).CreatePen(), ((GraphicsPathAdapter)path).GetClosedGeometry());
        }

        public override void DrawPath(RBrush brush, RGraphicsPath path)
        {
            this.Graphics.DrawGeometry(((BrushAdapter)brush).Brush, null, ((GraphicsPathAdapter)path).GetClosedGeometry());
        }
        ...
        public override void DrawPolygon(RBrush brush, RPoint[] points)
        {
            if (points != null && points.Length > 0)
            {
                ...
                this.Graphics.DrawGeometry(((BrushAdapter)brush).Brush, null, g);
            }
        }
